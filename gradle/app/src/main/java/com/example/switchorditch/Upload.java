...
public class Upload extends AppCompatActivity {
    ...
    Uri imageUri = null;
    ActivityResultLauncher<String> resultLauncherGalleryImage;
    ActivityResultLauncher<Intent> resultLauncherCameraImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resultLauncherGalleryImage = registerForActivityResult(new ActivityResultContracts.GetContent(), result -> retrieveImageFromGallery(result));

        resultLauncherCameraImage = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), result -> {
            if (result.getResultCode() == RESULT_OK){
                bitmapSelectedImage = BitmapFactory.decodeFile(currentPhotoPath);
                ExifInterface exif;
                try {
                ...
                try {
                    selectedImage = bitmapToFile(bitmapSelectedImage, selectedImage);
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
    ...
    private void retrieveImageFromGallery(Uri result) {
        imageUri = result;
    ...
    private void post(){
        ...
        if(validationString.equals("Continue")){
            ...
            RequestBody body = new MultipartBody.Builder()
                    ...
                    .addFormDataPart("user_id", sessionManager.getUsernameFromSession().get(SessionManager.KEY_USERNAME))
                    .build();
    ...
    public static File bitmapToFile(Bitmap bitmap, File file) throws IOException { // File name like "image.png"
    ...
    private void openCamera() {
        ...
        try {
            ...
            Uri imageUri = FileProvider.getUriForFile(Upload.this, "com.example.switchorditch.fileprovider", imageFile) ;

            Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
            intent.putExtra(MediaStore.EXTRA_OUTPUT, imageUri);
            intent.putExtra("imageFile", imageFile);
            resultLauncherCameraImage.launch(intent);
